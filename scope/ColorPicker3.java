...
public class ColorPicker3 extends JFrame implements MouseListener
{
   int h;
   Swatch b;
   Swatch[][] swatches; // 2-d array of Box objects, form a color pallet
   ...
   public ColorPicker3()
   {
      ...
      b = new Swatch( 450, 450, Color.orange );
      
      // declare array and fill with 400 boxes
      swatches = new Swatch[20][20];
      for ( int i=0; i<20; i++ )
      {
         for ( int j=0; j<20; j++ )
         {
            swatches[i][j] = new Swatch(10+20*i, 40+20*j, randomColor() );
         }
      }
   ...
   public void mouseClicked( MouseEvent e )
   {
      ...
      b.setColor( swatches[boxi][boxj].getColor() );
      repaint();
   }
